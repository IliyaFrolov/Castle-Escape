...
def scan(words):
    ...
    verbs = ['go', 'open', 'look', 'pull', 'take', 'grab', 'get', 'read', 'climb', 'pick', 'enter', 'walk']
    stop_words = ['the', 'in', 'through', 'at', 'it', 'to', 'big', 'main', 'a']
    nouns = ['door', 'trapdoor', 'lever', 'note', 'i', 'hall', 'inside', 'vault']
